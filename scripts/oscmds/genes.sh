...
# Some kind of problem. Too few genes?
...
# Some kind of problem in uniprot. Too few genes?
python TROILKATT.SCRIPTS/parseEntrezGeneInfo.py -i TROILKATT.META_DIR/Bacteria.gene_info -o TROILKATT.GLOBALMETA_DIR/genes/imp/ -k ecj > TROILKATT.LOG_DIR/parseBacteria_ecj.out 2> TROILKATT.LOG_DIR/parseBacteria_ecj.err
