...
IO.foreach(ARGV[0]) do |line|
	...
	cmd  = "/Genomics/Users/function/jdk1.6.0_02/bin/java -Xmx2g MedianMultiples " + ARGV[1] + parts[1] + "/" + parts[0] + ".mv.flt.knn.map.fly.pcl 1"
	cmd += " 1>" + ARGV[1] + parts[1] + "/" + parts[0] + ".mv.flt.knn.map.fly.mlm.pcl"
