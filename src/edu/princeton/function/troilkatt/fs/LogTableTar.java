 ...
 * support efficient random accesses to the individual log-files, which we assume some
 ...
 * -Each pipeline has a separate Table. This makes it easier to administer the system by for
...
public class LogTableTar extends LogTable {	
	 ...
	 * 
	 */
	public LogTableTar(String pipelineName) throws PipelineException {	
		super(pipelineName);
