...
/**
 * ExpoentiatePCL files that have been log transformed
 */
public class BatchPclExponentiate extends BatchPclCommon {
	
	/**
	 * Mapper
	 */
	public static class ExpoentiateMapper extends PclMapper {				
	...
	public int run(String[] cargs) {		
		...
		try {
			...
			/* Setup mapper */
			job.setMapperClass(ExpoentiateMapper.class);	    				
	...
	public static void main(String[] args) throws Exception {			
		BatchPclExponentiate o = new BatchPclExponentiate();
