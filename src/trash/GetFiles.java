...
public class GetFiles extends Troilkatt {
	private String progName = "GetFiles";
	...
	public void usage(String progName) {
		System.out.println(String.format("%s hdfs-directory output-directory [options]\n\n" + 
				"Required:\n" +
				"\thdfs-dir: HDFS directory with files to download.\n"+
	...
	public void run(String[] argv) {
		...
		setupLogging(args.get("logging"), troilkattProperties.get("troilkatt.logdir"), progName + ".log");
